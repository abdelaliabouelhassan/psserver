                        ...
                        <div class="col-sm-5">
                            <div class="row">
                                ...
                                <div class="col-10 m-auto">
                                    <div class="row">
                                        <div class="col-3">
                                            <h5 class="d-inline-block px-3 py-2 rounded text-white">3</h5>
                                        </div>
                                        <div class="col-9">
                                            <p class="hard text-danger bg-pink rounded">
                                                Hard
                                            </p>
                                            <h5 class="font-weight-bold">Asenis.eu</h5>
                                        </div>
                                    </div>
                                    <div class="row"></div>
                                    <p class="zuko-text">Zuko2.com - Comeback - 14.08.2020 Big International Server</p>
                        ...
                        <div class="col-sm-5">
                            <div class="row">
                                ...
                                <div class="col-10 m-auto">
                                    <div class="row">
                                        <div class="col-3">
                                            <h5 class="d-inline-block px-3 py-2 rounded text-white">4</h5>
                                        </div>
                                        <div class="col-9">
                                            <p class="hard text-success bg-green rounded">
                                                Easy
                                            </p>
                                            <h5 class="font-weight-bold">Tastria.pl</h5>
                                        </div>
                                    </div>
                                    <div class="row"></div>
                                    <p class="zuko-text">Zuko2.com - Comeback - 14.08.2020 Big International Server</p>
