    ...
    <div class="col-md-4 my-1">
        ...
        <div class="card firstCard py-5 mt-4" v-if="server">
            <div class="container">
                ...
                <p class="mt-4 mb-3 text-white card-lorem">{{server.short_description}}</p>
                <p>
                  <span>
                ...
                <a @click="goDetails(server.slug)" class="btn btn-light mt-5 d-inline">{{$t('message.VISIT_WEBSITE')}}</a>
